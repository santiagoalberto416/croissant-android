...
public class ListAdapter_mesage extends BaseAdapter
{
    private Activity activity;
    private ArrayList<Question> data;
    private static LayoutInflater inflater;

    public ListAdapter_mesage(Activity activity, ArrayList<Question> data)
    {
    ...
    public View getView(int position, View view, ViewGroup parentView)
    {
        ...
        RelativeLayout btnDeclined = (RelativeLayout)v.findViewById(R.id.contentdecline);

        // agregamos el evento que hara el 'boton' al momento de hacer click
        btnDeclined.setOnClickListener(sendDeclinedQuestion);
    ...
    private View.OnClickListener sendDeclinedQuestion = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            ListView list = (ListView)activity.findViewById(R.id.lvAsksOfConference);
            final int position = list.getPositionForView((View) v.getParent());
            GoAndShowQuestionsManage.sendDeclinedQuestion(position);
        }
    };
